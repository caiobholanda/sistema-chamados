...
(function () {
  ...
  const adminDropdownPages = ['/admin-itens.html', '/admin-sugestoes.html', '/admin-servicos.html', '/admin-programados.html'];
  ...
  html += `<div class="nav-dropdown" id="nav-admin-dropdown">
    ...
    <div class="nav-dropdown-menu">
      <a href="/admin-itens.html"${path === '/admin-itens.html' ? ' class="ativo"' : ''}>Inventário</a>
