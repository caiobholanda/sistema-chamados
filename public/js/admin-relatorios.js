...
function renderConteudo(dados, ranking, mes) {
  const { volumeStatus, totalMes, totalMesAnt, abertosUltimos12, notaMedia,
          tendencia6m, top5Setores, porCategoria, tempoMedioRespostaSeg, sla,
          totalAbertosAtual, totalAndamentoAtual } = dados;
  ...
  document.getElementById('conteudo').innerHTML = `
    <div class="rel-hero">
      ...
      <div class="kpi">
        ...
        <div class="kpi-val" style="color:#1D4ED8">${totalAbertosAtual}</div>
      ...
      <div class="kpi">
        ...
        <div class="kpi-val" style="color:#7C3AED">${totalAndamentoAtual}</div>
