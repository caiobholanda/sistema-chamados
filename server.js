...
app.get('/spa-profile.html', (req, res) => servirHtmlComVersao(res, 'spa-profile.html'));
app.get('/admin-spa.html', (req, res) => servirHtmlComVersao(res, 'admin-spa.html'));
app.get('/spa-pesquisa.html', (req, res) => servirHtmlComVersao(res, 'spa-pesquisa.html'));
...
app.use('/api/spa', require('./src/rotas/spa'));
