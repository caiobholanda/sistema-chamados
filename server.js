...
app.get('/spa-profile.html', (_req, res) => res.redirect(301, 'https://pesquisa-satisfacao.fly.dev/spa-profile.html'));
app.get('/admin-spa.html', (_req, res) => res.redirect(301, 'https://pesquisa-satisfacao.fly.dev/admin.html'));
app.get('/spa-pesquisa.html', (_req, res) => res.redirect(301, 'https://pesquisa-satisfacao.fly.dev/'));
...
// SPA movido para pesquisa-satisfacao.fly.dev
